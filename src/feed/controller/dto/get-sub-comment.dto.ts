...
class GetSubCommentRequest extends PaginationRequest {
    ...
    toQuery(feedId: Types.ObjectId, commentId: Types.ObjectId, userId: Types.ObjectId): GetSubCommentQuery {
        return {
            page: this.page,
            size: this.size,
            feedId: feedId,
...
class GetSubCommentResponse {
    ...
    constructor(data: {[P in keyof GetSubCommentResponse]: GetSubCommentResponse[P]}) {
        Object.assign(this, data)
    }
    
    static of(comments: Partial<FeedComment>[], userId: Types.ObjectId): GetSubCommentResponse[] {
